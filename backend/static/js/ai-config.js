...
const providerPresets = {
    ...
    siliconflow: {
        displayName: '硅基流动',
        logo: '/static/assets/provider-logos/siliconflow.svg',
        defaultModels: ['siliconflow/Yi-1.5-34B-Chat', 'siliconflow/Yi-1.5-9B-Chat'],
...
function getProviderHelpText(providerName) {
    ...
    'siliconflow': '从<a href="https://cloud.siliconflow.cn/keys" target="_blank" style="color: var(--accent-blue);">硅基流动控制台</a>获取 API Key'
};
